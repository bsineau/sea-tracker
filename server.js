...
const BUILD = '25/07 — AIS classe B';
...
function aisConnect(force) {
  ...
  ws.onopen = () => {
    ...
    /* PositionReport = classe A uniquement (navires de commerce). Les voiliers
       de course emettent en classe B : sans ces deux types, aisstream ne
       transmet rien pour une flotte de voile. */
    const sub = { APIKey: AIS_KEY, BoundingBoxes: [[[-90, -180], [90, 180]]], FiltersShipMMSI: list, FilterMessageTypes: ['PositionReport', 'StandardClassBPositionReport', 'ExtendedClassBPositionReport'] };
