...
function boatAdd(id,name,p,dejaTrace){
  ...
  if(!b.marker){
    b.marker=L.circleMarker(ll,{radius:6,color:'#fff',weight:1.6,fillColor:b.color,fillOpacity:1}).addTo(map)
      .bindTooltip(etiquette(b),{permanent:true,direction:'right',offset:[9,0],className:'boat-name'});
...
<html lang="fr">
<head><link rel="manifest" href="__MANIFEST__"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="black-translucent"><meta name="apple-mobile-web-app-title" content="Sea Tracker"><meta name="theme-color" content="#0a1a26"><link rel="apple-touch-icon" href="/icon-180.png"><link rel="icon" href="/icon-192.png"><script>if("serviceWorker" in navigator)document.getElementById('diagBtn').onclick=function(){
  ...
  api('/api/admin/diag').then(function(r){
    ...
    var det=d.aisDetail||[];
    if(det.length){
      var muets=det.filter(function(x){return x.dernierRecuIlYaMin===null;});
      var vieux=det.filter(function(x){return x.dernierRecuIlYaMin!==null;}).slice(0,15);
      h+='<div style="font-weight:700;margin:10px 0 6px">Bateaux AIS ('+det.length+' suivis, '+muets.length+' jamais reçus depuis le démarrage)</div>';
      det.slice(0,25).forEach(function(x){
      ...
      if(det.length>25) h+='<div style="color:#8fb0c4">… et '+(det.length-25)+' autres (JSON complet : /api/admin/diag)</div>';
    }
...
const BUILD = '25/07 — diag dans la console';
