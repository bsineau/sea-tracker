...
if(owmKey){
  var owm=function(layer){return L.tileLayer('https://tile.openweathermap.org/map/'+layer+'/{z}/{x}/{y}.png?appid='+owmKey,
    {opacity:0.55,maxNativeZoom:12,maxZoom:18,attribution:'Météo &copy; OpenWeather'});};
...
var owmKey=(window.OWM_KEY||'');
if(owmKey){
  var owm=function(layer){return L.tileLayer('https://tile.openweathermap.org/map/'+layer+'/{z}/{x}/{y}.png?appid='+owmKey,{opacity:0.55,maxNativeZoom:12,maxZoom:18,attribution:'Météo &copy; OpenWeather'});};
...
const BUILD = '31/07 — calques meteo visibles';
